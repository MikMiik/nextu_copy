    ...
    <div className="w-full max-w-7xl mx-auto px-2 py-10">
      <div className="text-center mb-8">
        ...
        <p className="text-brand-secondary/80">
          Manage all your package requests and event bookings here.
        </p>
      </div>
      ...
      >
        ...
        <TabsContent value="packages" className="space-y-6">
          <div className="bg-brand-light border border-brand-light/30 rounded-lg p-4 mb-6">
            ...
            <p className="text-brand-secondary/80 mt-1">
              View and manage your package requests, payments, and statuses.
            </p>
          </div>
          <PackageHistory searchParams={searchParams} />
        </TabsContent>
        ...
        <TabsContent value="ecosystem" className="space-y-6">
          <div className="bg-brand-light border border-brand-light/30 rounded-lg p-4 mb-6">
            ...
            <p className="text-brand-secondary/80 mt-1">
              View and manage your event tickets, add-ons, and payment status.
            </p>
          </div>
          <EventBookingHistory />
        </TabsContent>
