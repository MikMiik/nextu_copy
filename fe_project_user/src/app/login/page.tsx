        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-3 flex items-center text-brand-secondary/40 hover:text-brand-secondary/70"
                >
                  {showPassword ? (
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label
                htmlFor="remember"
                className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-brand-secondary/80"
              >
                Remember me
              </Label>
            </div>
            ...
            <Button
              type="submit"
              className="w-full rounded-full bg-brand-primary hover:bg-brand-primary/90 text-brand-light"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
                  <Loader2 className="mr-2 h-4 w-4 animate-spin text-brand-light" />
                  Signing in...
                </>
              ) : (
                "Sign In"
