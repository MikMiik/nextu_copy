        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <Link href="https://www.facebook.com/nextuliving/" className="text-slate-400 hover:text-[#28c4dd] transition-colors">
              ...
              <Link href="https://www.linkedin.com/company/nextuliving/" className="text-slate-400 hover:text-[#28c4dd] transition-colors">
                <Linkedin className="h-5 w-5" />
              </Link>
              <Link href="https://www.youtube.com/@universenext" className="text-slate-400 hover:text-[#ff0000] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/community" className="text-slate-300 hover:text-[#28c4dd] transition-colors">
                  Community
                </Link>
              </li>
              <li>
                <Link href="/partners" className="text-slate-300 hover:text-[#28c4dd] transition-colors">
                  Partners
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/contact" className="text-slate-300 hover:text-[#28c4dd] transition-colors">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link href="/blog" className="text-slate-300 hover:text-[#28c4dd] transition-colors">
                  Blog & Journal 
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/spaces" className="text-slate-300 hover:text-[#28c4dd] transition-colors">
                  Spaces & Houses
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/membership" className="text-slate-300 hover:text-[#28c4dd] transition-colors">
                  Membership & Pricing
                </Link>
              </li>
              <li>
                <Link href="/faqs" className="text-slate-300 hover:text-[#28c4dd] transition-colors">
                  Policies & FAQs
                </Link>
              </li>
            </ul>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  Level 3 A17 Building Hanoi University of Science and Technology,<br />
                  Ta Quang Buu Street,<br />
                  Hai Ba Trung, Hanoi
                  </p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <span className="text-slate-300 text-sm">+84 93 558 9898 </span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-[#28c4dd] flex-shrink-0" />
                <span className="text-slate-300 text-sm">admin@nextu.vn</span>
              </div>
            </div>
          </div>
        </div>
