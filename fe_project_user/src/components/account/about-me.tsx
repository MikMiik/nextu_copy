...
export default function AboutMePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4">
      <form
        className="bg-brand-light/80 rounded-2xl shadow p-10 w-full border border-brand-light/30"
        onSubmit={(e) => {
          e.preventDefault();
          handleSave();
        }}
      >
        <div className="space-y-8">
          <div className="flex items-center">
            <label className="w-56 font-bold text-lg text-brand-secondary text-left">
              Full name
            </label>
            <input
              className="flex-1 h-12 border border-brand-light/30 rounded-xl px-4 text-base shadow-sm bg-brand-light/95 text-brand-secondary"
              value={fullName}
        ...
        <div className="flex justify-end mt-8">
          <button
            type="submit"
            className="px-8 py-2 bg-brand-secondary text-brand-light rounded-xl text-base font-semibold disabled:opacity-50"
            disabled={saving}
          >
