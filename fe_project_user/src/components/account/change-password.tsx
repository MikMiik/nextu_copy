  ...
  return (
    <div>
      ...
      <div className="bg-brand-light rounded-lg shadow p-8 max-w-3xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div>
            ...
            <div className="relative">
              ...
              <button
                type="button"
                className="absolute right-3 top-1/2 transform -translate-y-1/2 text-brand-secondary hover:text-brand-secondary/90"
        ...
        <div className="mb-4 p-3 bg-brand-light rounded text-sm text-brand-secondary border border-brand-secondary/10">
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            className="px-6 py-2 bg-brand-secondary text-white rounded disabled:opacity-50 hover:bg-brand-secondary/90 transition-colors"
            onClick={handleSave}
            disabled={saving}
          >
            {saving ? "Saving..." : "Save"}
