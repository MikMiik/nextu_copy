...
export function DatePickerModal({ open, onOpenChange, onDatesSelect }: DatePickerModalProps) {
  ...
  // Tính toán ngày giới hạn: từ ngày mai đến 2 tuần sau
      ...
      <DialogContent className="max-w-2xl p-0 bg-white">
        <div className="px-8 pt-10 pb-8 flex flex-col items-center">
          <div className="flex flex-col items-center w-full mb-8">
            ...
            <p className="text-sm text-gray-600 mt-3 text-center">You can select dates within the next 2 weeks</p>
          </div>
          <div className="flex justify-center w-full mb-10">
            <Calendar
              ...
              disabled={date => date < tomorrow || date > twoWeeksFromToday}
            />
          </div>
