...
export const roomService = {
  ...
  // Lấy thông tin chi tiết room instance theo ID
  getRoomInstanceById: async (roomInstanceId: string): Promise<RoomInstance> => {
    const response = await api.get(`/api/membership/RoomInstances/${roomInstanceId}`)
    return response.data
  }
} 